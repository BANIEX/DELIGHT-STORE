...
export default function Cell({
  ...
  const imageFunctionValue = (image_url) => {
    // setValue({ value: image_url, update: false });
    // onChange()
    console.log(image_url)
  
    setValue({value: image_url, update: true})
    console.log(value)
  ...
  switch (dataType) {
    ...
    case "button":
        element = (
          // <input type={"button"} value={value.value}></input>
          <CloudinaryUploadWidget
            imageFunctionValue={imageFunctionValue}
            onBlur={() =>
