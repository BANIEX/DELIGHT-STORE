        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="${email_url}" target="_blank" style="display: inline-block;">
                <img src="https://i.im.ge/2023/01/06/qGoEKX.Delight-logo-png.png" alt="Logo" border="0" width="48" style="display: block; width: 90px; max-width: 90px; min-width: 48px;">
              </a>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              ...
              <p style="margin: 0;"><a href='${email_link}' target="_blank">${email_link}</a></p>
            </td>
          </tr>
          <!-- end copy -->
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
              <p style="margin: 0;">Cheers,<br> Team Delight</p>
            </td>
          </tr>
          <!-- end copy -->
...
<!--               <p style="margin: 0;">To stop receiving these emails, you can <a href="https://www.blogdesire.com" target="_blank">unsubscribe</a> at any time.</p> -->
              <p style="margin: 0;">NO 43, SHASHA AKOWONJO ROAD, OFF MOBIL FILLING STATION,ALIMOSHO, LAGOS STATE</p>
            </td>
          </tr>
          <!-- end unsubscribe -->
